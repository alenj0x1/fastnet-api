...
builder.Services.AddDbContext<FastnetdbContext>(options =>
...
builder.Services.AddDbContext<FastnetdbContext>(opt =>
{
    opt.UseSqlServer(builder.Configuration.GetValue<string>("DB:connection"));
});
